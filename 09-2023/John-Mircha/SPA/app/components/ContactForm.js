export function ContactForm() {
  ...
  formElement.classList.add("contact-form");
  ...
  <legend>En que puedo ayudarte?</legend>
        <input
          type="text"
          name="name"
        ...
        <div class="contact-form-loader none">
          <img src="./app/assets/audio.svg" alt="Cargando" />
        </div>
  ...
  // Function copy from another exercise
  function validationForm() {
    ...
    document.addEventListener("submit", (event) => {
      ...
      const url = "assets/send_mail.php";
